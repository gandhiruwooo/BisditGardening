...
<div class="flex items-center justify-center px-10">
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
        ...
        <div class="relative rounded-3xl my-4">
            <div class="mt-5">
                <div class="flex">
                    <img src="img/rsz_1.png" class= "w-auto" style="border-radius: 5%">
        ...
        <a href="detailtanaman.html">
            <div class="relative bg-black rounded-3xl my-1 shadow-xl transition-colors duration-150 hover:bg-green-800">
                <div class="mt-5">
                        <p class="items-center pt-3 h-14 px-4 m-2 text-lg text-gray-50 font-bold my-2">  1. Lidah Mertua "Silverqueen" </p>
                </div>
            </div>  
        </a> 
          <!--list tanaman-->
        <a href="detailtanaman.html">
            <div class="relative bg-black rounded-3xl my-4 shadow-xl transition-colors duration-150 hover:bg-green-800">
                <div class="mt-5">
                        <p class="items-center pt-3 h-14 px-4 m-2 text-lg text-gray-50 font-bold my-2">  2. Tumbuhan Pakis </p>
                    </div>
            </div>  
        </a> 
              <!--list tanaman-->
        <a href="detailtanaman.html">
            <div class="relative bg-black rounded-3xl my-4 shadow-xl transition-colors duration-150 hover:bg-green-800">
                <div class="mt-5">
                        ...
                        <p class="items-center pt-3 h-14 px-4 m-2 text-lg text-gray-50 font-bold my-2">  3. Karet Merah </p>
                </div>
            </div>
        </a> 
        <div class="pt-16">
