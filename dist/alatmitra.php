...
$alat_all = query("SELECT * FROM harga_alat WHERE mitra_id=$id");
...
$alats = query("SELECT * FROM harga_alat WHERE mitra_id=$id LIMIT $data_awal,$jumlah_data");
...
<!--Judul-->
<h1 class="text-center text-green-900 text-3xl title-font font-medium mb-1 py-2 pt-10"><b>Daftar Alat Mitra <?php echo $mitra["mitra_nama"]; ?></b></h1>
		<!--Pagination-->
